document.addEventListener('DOMContentLoaded', () => {
    ...
    let products = JSON.parse(localStorage.getItem('productsList_P4')) || initialProducts;
                    ...
                    if (choice === "1") {
                        ...
                        if (newName && newName.trim() && newName.trim().toUpperCase() !== p) {
                            ...
                            if (index !== -1) {
                                ...
                                localStorage.setItem('inventoryData', JSON.stringify(inventoryData));
                                localStorage.setItem('productsList_P4', JSON.stringify(products));
                                renderTable();
                            }
                        }
                    } else if (choice === "2") {
    ...
    if (downloadBtn) {
        downloadBtn.onclick = async () => {
            ...
            row2.values = ["PASILLO Nº 4 GALLETAS 🛒 DE FERIA DEL ESTE 🛒"];
